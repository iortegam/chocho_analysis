...
def main(argv):
    ...
    #---------------------------------
    if pltInputs['pltdoiEx']:
        gas.pltExdoi(fltr=pltInputs['fltrFlg'], maxrms= pltInputs['maxRMS'] , minsza=pltInputs['minSZA'],
             ...
             VAFlg=pltInputs['VAFlg'], title='All data', ver2plt=pltInputs['versions'][0], dois= pltInputs['doi_cs'])
